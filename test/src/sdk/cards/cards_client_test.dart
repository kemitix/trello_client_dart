  ...
  group(
      ...
      () => apiTest<TrelloCard>(
          ...
          responseValues: [
            ...
            testValue('manualCoverAttachment', (r) => r.manualCoverAttachment,
                isTrue),
            ...
            testValue(
                'locationName', (r) => r.locationName, 'my-location-name'),
  ...
  group(
      ...
      () => apiTest<List<TrelloAttachment>>(
            ...
            responseValues: [
              ...
              testValue('edgeColor', (r) => r[0].edgeColor, 'my-edge-color'),
